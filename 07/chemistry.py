def make_periodic_table():
    """ 
    description: make a list of two dimensions with the values of each 
    atom value

    return: the hole periodic table
     """
    pt = {
        "Ac": [	"Actinium",	227],
        "Ag": [	"Silver",	107.8682],
...
def main():
    ...
    name = 1
    atomic_mass = 2
    for row in periodict_table:
        print( f'{row[name]} {row[atomic_mass]}' )
        print() """
